...
\begin{p}
  ...
  \item
    \begin{subp}
      ...
      \item
        ...
        If $\vec{v} \ne \vec{w} \in V$,
        \begin{gather}
          <\vec{v}_0, \vec{w}> = <\vec{v}, \varphi^*(\vec{w})> \\
          <\vec{v}_0, \vec{w}> = <\vec{v}, \vec{v}_0> \\
          <\vec{w}, \vec{v}_0> = <\vec{v}, \vec{v}_0> \\
          \vec{v} = \vec{w}
        \end{gather}
  ...
  \item
    \begin{subp}
      \item
        \begin{gather}
          <\varphi(\vec{v}), \vec{w}> = <\vec{v}, \varphi^*(\vec{w})> \\
          <\varphi^*(\vec{w}), \vec{v}> = <\vec{w}, \varphi(\vec{w})> \\
